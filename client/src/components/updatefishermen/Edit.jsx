...
const Editfishermen = () => {
    ...
    const validateExperience = (experience, setError) => {
        setError('');
            ...
            if (experienceNumber < 0) {
                setError('Product Price must be greater than 2 years.');
                toast.error('Product Price must be greater than 2 years.', {
                    position: 'top-center',
                    autoClose: 1000,
    ...
    const validateAge = (age, setError) => {
        ...
        if (!/^\d+$/.test(age)) {
            setError('Supplier ID must be a number');
        ...
        if (age.length >= 2) {
            ...
            if (!/^\d+$/.test(age) ) {
                setError('Supplier ID must be a number');
                toast.error('Supplier ID must be a number.', {
                    position: 'top-center',
                    autoClose: 1000,
    ...
    const submitForm = async(e)=>{
        ...
        if (isNaN(parseInt(fishermen.experience)) || parseInt(fishermen.experience) <= 0) {
            toast.error('Product Price must be greater than 2 years.', {position: "top-center"})
            return;
        }
                ...
                <div className="Fishermen_form-container">
                    ...
                    <form className="addFishermenForm" onSubmit={submitForm}>
                        ...
                        <div className="Fishermen_inputGroup">
                            ...
                            <input type="text" value={fishermen.age} onChange={(event) => {ageinputHandler(event); handleInputChangeAge(event);}} id="age" name="age" autoComplete='off' placeholder="Enter ID"/>
                        </div>
                        <div className="Fishermen_inputGroup">
                        ...
                        <div className="Fishermen_inputGroup">
                            ...
                            <input type="text" value={fishermen.address} onChange={inputChangeHandler} id="address" name="address" autoComplete='off' placeholder="Enter Product Type"/>
                        </div>
                        <div className="Fishermen_inputGroup">
                            <label htmlFor="experience">Product Price</label> <br />
                            <input type="text" value={fishermen.experience} onChange={(event) => {expinputHandler(event); handleInputChangeExp(event);}} id="experience" name="experience" autoComplete='off' placeholder="Enter Price"/>
                        </div>
                        <div className='Fishermen_inputGroup'>
